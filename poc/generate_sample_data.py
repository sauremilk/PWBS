...
def generate_calendar_events() -> int:
    ...
    for i, event in enumerate(CALENDAR_EVENTS):
        ...
        event_data = {
            ...
            "end": {"dateTime": (event_date + timedelta(hours=1)).isoformat() + "+01:00"},
            "attendees": [
...
def generate_notes() -> int:
    ...
    for i, note in enumerate(NOTES):
        ...
        filename = note["title"].replace(" ", "-").replace(":", "").replace("/", "-").lower()
