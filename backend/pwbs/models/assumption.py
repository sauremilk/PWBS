...
class Assumption(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    # Relationships
    user: Mapped[User] = relationship(back_populates="assumptions")  # noqa: F821  # type: ignore[name-defined]
    source_decision: Mapped[Decision | None] = relationship()  # noqa: F821  # type: ignore[name-defined]
