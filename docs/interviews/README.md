# Interview-Auswertungssystem

## Übersicht

Dieses Verzeichnis enthält das Auswertungssystem für die strukturierten Probleminterviews (15–20 geplant).
...
1. **Interview durchführen** mit `interview-guide.md` als Leitfaden
2. **Auswertung ausfüllen** mit Kopie von `evaluation-template.md` → speichern als `results/INT-001.md`
3. **Daten in Spreadsheet eintragen** via `results-spreadsheet.csv` (Import in Google Sheets)
4. **Aggregation aktualisieren** in `aggregation-dashboard.md` nach jedem Interview
