# PWBS  CloudFront CDN Module
# CDN fuer Frontend-Assets und API-Caching (TASK-146)
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  price_class         = "PriceClass_100" # EU + Nordamerika
  aliases             = var.domain_aliases
  comment             = "PWBS Frontend  ${var.environment}"
