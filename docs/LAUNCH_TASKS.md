...
| **Zeitrahmen**         | 8 Wochen (4 Sprints � 2 Wochen)                                                                                                                                                                                                                                      |
...
| Priorit�t | Bedeutung                               | Anzahl |
| :-------: | --------------------------------------- | :----: |
|  **P0**   | Blocker � Closed Beta nicht startbar    |   15   |
|  **P1**   | Wichtig � signifikante Qualit�tsrisiken |   11   |
|  **P2**   | W�nschenswert � verbessert Erlebnis     |   13   |
|           | **Gesamt**                              | **39** |
...
| -------------- | ---------------------- | ------------------------------------------------------- |
| LAUNCH-REL-001 | TASK-013 (CI/CD)       | pip-audit/npm-audit als Schritt in CI-Pipeline einf�gen |
...
#### LAUNCH-LEG-001: Datenschutzerkl�rung erstellen
...
#### LAUNCH-REL-006: CORS auf genutzte Werte einschr�nken
...
#### LAUNCH-UX-006: Zur�ck-Navigation im Wizard
...
#### LAUNCH-UX-009: Onboarding-Wizard vollst�ndig integrieren
...
| **Priorit�t**           | P0                                                                             |
| **Kategorie**           | GTM                                                                            |
| **Akzeptanzkriterium**  | 3�5 best�tigte Design-Partner, die am Closed-Beta-Onboarding teilnehmen werden |
| **Abh�ngigkeit**        | �                                                                              |
| **Gesch�tzter Aufwand** | M                                                                              |
| **Status**              | Blockiert — Manuelle Aktion: LinkedIn Outreach + persönliches Netzwerk         |

**Beschreibung:** 3�5 Design-Partner aus dem Zielgruppenprofil (Wissensarbeiter, 28�45, = 3 SaaS-Quellen) �ber LinkedIn Direct Outreach und pers�nliches Netzwerk gewinnen. Value Proposition: Erster Zugang + direkter Einfluss auf Produkt + lebenslanger Gratis-Zugang. W�chentliche 15-Min-Feedback-Calls vereinbaren.
...
#### LAUNCH-GTM-004: LinkedIn-Pr�senz aufbauen
...
#### LAUNCH-GTM-005: Obsidian-Plugin ver�ffentlichen
...
## 3. Abh�ngigkeitsgraph

```mermaid
graph TD
    subgraph "P0 � Blocker"
        LEG001[LAUNCH-LEG-001<br>Datenschutzerkl�rung]
...
Alle anderen Tasks haben keine Abh�ngigkeiten und k�nnen parallel bearbeitet werden.
...
| -------------- | ----------------------- | :-----: | :--: |
| LAUNCH-LEG-001 | Datenschutzerkl�rung    |    M    |  P0  |
...
**Sprint-Ziel:** Alle rechtlichen Pflichtdokumente angesto�en, Security-Blocker geschlossen, Monitoring-Infrastruktur bereit.

---

### Sprint 2 (Woche 3�4): Qualit�t & Events
...
### Sprint 3 (Woche 5�6): UX-Polish & Ops-H�rtung
...
| LAUNCH-GTM-006 | Exit-Kriterien pr�fen  |    S    |  P1  |

**Sprint-Ziel:** E2E-Test und TTFB validiert. Ops-Runbooks fertig. Demo-Material bereit. Closed-Beta-Readiness �berpr�ft.
...
| Task           | Beschreibung                | Aufwand | Prio |
| -------------- | --------------------------- | :-----: | :--: |
| LAUNCH-UX-006  | Wizard Zur�ck-Navigation    |   XS    |  P2  |
...
| LAUNCH-REL-006 | CORS einschr�nken           |   XS    |  P2  |
...
| ------------ | ------------------------------------------------------------------------ | :-------: | ---------------------------------- |
| PL-OB-LEG-01 | Formale DSFA durchf�hren (Art. 35 DSGVO, Fokus LLM + Knowledge Graph)    |    LEG    | LEGAL_COMPLIANCE W-1, LEG-OB-01    |
...
| PL-OB-LEG-04 | Drittdaten-Strategie kl�ren (Zoom-Transkripte, Meeting-Teilnehmer)       |    LEG    | LEGAL_COMPLIANCE W-3               |
| PL-OB-LEG-05 | EU-Datenresidenz bei LLM-Providern kl�ren (SCCs, TIA)                    |    LEG    | LEGAL_COMPLIANCE W-4               |
| PL-OB-LEG-06 | Sentry-AVV abschlie�en (falls aktiviert)                                 |    LEG    | LEGAL_COMPLIANCE W-9               |
| PL-OB-LEG-07 | Prozess f�r Betroffenenanfragen Dritter definieren                       |    LEG    | LEGAL_COMPLIANCE W-10              |
...
| PL-OB-UX-04  | ConsentDialog vereinfachen (verk�rzte Variante im Wizard)                |    UX     | UX_ONBOARDING_SPEC �9 Minor #12    |
...
| PL-OB-UX-08  | Partial Briefing vor vollst�ndigem Sync (O-4)                            |    UX     | UX_ONBOARDING_SPEC �9 Major #9     |
...
| PL-OB-ANA-05 | PostHog-Person l�schen bei Account-L�schung                              |    ANA    | TRACKING Phase 4 #21               |
...
| PL-OB-GTM-03 | Reddit-Pr�senz (r/ObsidianMD, r/PKMS)                                    |    GTM    | GTM_PLAN �7 Monat 2                |
...
| ID           | Beschreibung                                                                   | Kategorie | Quelle                          |
| ------------ | ------------------------------------------------------------------------------ | :-------: | ------------------------------- |
| PL-GA-LEG-01 | DPA-Template f�r Enterprise-Kunden                                             |    LEG    | LEGAL_COMPLIANCE G-1, LEG-GA-01 |
| PL-GA-LEG-02 | KI-Kennzeichnung vollst�ndig Art. 50 EU AI Act konform                         |    LEG    | LEG-GA-02                       |
| PL-GA-LEG-03 | Drittdaten-Strategie abschlie�end rechtlich bewertet                           |    LEG    | LEG-GA-03                       |
| PL-GA-LEG-04 | Datenschutzbeauftragten benennen (Pr�fung ob Pflicht)                          |    LEG    | LEGAL_COMPLIANCE G-2            |
| PL-GA-LEG-05 | Embedding-Vektoren rechtlich bewerten lassen                                   |    LEG    | LEGAL_COMPLIANCE G-8            |
| PL-GA-LEG-06 | J�hrliche DSGVO-Schulung durchf�hren                                           |    LEG    | LEGAL_COMPLIANCE G-5            |
...
| PL-GA-GTM-02 | D30-Retention > 50 % �ber = 3 Kohorten nachweisen                              |    GTM    | PRD-GA-02                       |
...
| RELEASE_READINESS.md       | Struktur f�r alle Kategorien (SEC, LEG, QA, UX, ANA, OPS, CNT) |               16                |

---

_Generiert: 2026-03-17 | N�chste Review: Sprint-1-Retrospektive_
